...
/**
 * This is the item provider adapter for a {@link Sequencediagram.sequencediagram.LifeLine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LifeLineItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SequencediagramPackage.Literals.LIFE_LINE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addStartPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_LifeLine_start_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_LifeLine_start_feature", "_UI_LifeLine_type"),
				 SequencediagramPackage.Literals.LIFE_LINE__START,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SequencediagramPackage.Literals.LIFE_LINE__ABSTRACT_OBJECT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SequencediagramPackage.Literals.LIFE_LINE__ABSTRACT_OBJECT,
