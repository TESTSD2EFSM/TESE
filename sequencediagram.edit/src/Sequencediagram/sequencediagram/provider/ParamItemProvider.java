...
/**
 * This is the item provider adapter for a {@link Sequencediagram.sequencediagram.Param} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParamItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Param_argName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Param_argName_feature", "_UI_Param_type"),
				 SequencediagramPackage.Literals.PARAM__ARG_NAME,
				 true,
				 false,
				 false,
	...
	protected void addArgTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Param_argType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Param_argType_feature", "_UI_Param_type"),
				 SequencediagramPackage.Literals.PARAM__ARG_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLifelinePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Param_lifeline_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Param_lifeline_feature", "_UI_Param_type"),
				 SequencediagramPackage.Literals.PARAM__LIFELINE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((Param)object).getArgName();
