...
/**
 * This is the item provider adapter for a {@link Sequencediagram.sequencediagram.SequenceDiagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SequenceDiagramItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SequenceDiagram_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SequenceDiagram_name_feature", "_UI_SequenceDiagram_type"),
				 SequencediagramPackage.Literals.SEQUENCE_DIAGRAM__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SequencediagramPackage.Literals.SEQUENCE_DIAGRAM__LIFE_LINES);
			childrenFeatures.add(SequencediagramPackage.Literals.SEQUENCE_DIAGRAM__FRAGMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SequencediagramPackage.Literals.SEQUENCE_DIAGRAM__LIFE_LINES,
				 SequencediagramFactory.eINSTANCE.createLifeLine()));

		newChildDescriptors.add
			(createChildParameter
				(SequencediagramPackage.Literals.SEQUENCE_DIAGRAM__FRAGMENTS,
				 SequencediagramFactory.eINSTANCE.createMessage()));

		newChildDescriptors.add
			(createChildParameter
				(SequencediagramPackage.Literals.SEQUENCE_DIAGRAM__FRAGMENTS,
				 SequencediagramFactory.eINSTANCE.createCombinedFragment()));
	}
