...
/**
 * This is the item provider adapter for a {@link Sequencediagram.sequencediagram.InteractionOperand} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InteractionOperandItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SequencediagramPackage.Literals.INTERACTION_OPERAND__GUARD,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SequencediagramPackage.Literals.INTERACTION_OPERAND__FRAG_OPDS);
		}
	...
	public String getText(Object object) {
		String label = ((InteractionOperand)object).getGuard();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SequencediagramPackage.Literals.INTERACTION_OPERAND__FRAG_OPDS,
