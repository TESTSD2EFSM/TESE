/**
 */
package Sequencediagram.sequencediagram.provider;
...
/**
 * This is the item provider adapter for a {@link Sequencediagram.sequencediagram.Operation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operation_returnVariable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Operation_returnVariable_feature", "_UI_Operation_type"),
				 SequencediagramPackage.Literals.OPERATION__RETURN_VARIABLE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SequencediagramPackage.Literals.OPERATION__RETURN_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addGuardPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operation_guard_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Operation_guard_feature", "_UI_Operation_type"),
				 SequencediagramPackage.Literals.OPERATION__GUARD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SequencediagramPackage.Literals.OPERATION__ARGS);
		}
	...
	public String getText(Object object) {
		String label = ((Operation)object).getReturnVariable();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Operation.class)) {
			...
			case SequencediagramPackage.OPERATION__GUARD:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SequencediagramPackage.Literals.OPERATION__ARGS,
				 SequencediagramFactory.eINSTANCE.createParam()));
	}
