...
/**
 * This is the item provider adapter for a {@link Sequencediagram.sequencediagram.CombinedFragment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CombinedFragmentItemProvider extends InteractionFragmentItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CombinedFragment_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CombinedFragment_name_feature", "_UI_CombinedFragment_type"),
				 SequencediagramPackage.Literals.COMBINED_FRAGMENT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SequencediagramPackage.Literals.COMBINED_FRAGMENT__INTERACTION_OPERATOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SequencediagramPackage.Literals.COMBINED_FRAGMENT__OPERANDS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SequencediagramPackage.Literals.COMBINED_FRAGMENT__OPERANDS,
				 SequencediagramFactory.eINSTANCE.createInteractionOperand()));
	}
