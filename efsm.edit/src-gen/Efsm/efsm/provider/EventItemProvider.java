...
/**
 * This is the item provider adapter for a {@link Efsm.efsm.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						EfsmPackage.Literals.EVENT__NAME, true, false, false,
	...
	protected void addReturnPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Event_return_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Event_return_feature", "_UI_Event_type"),
						EfsmPackage.Literals.EVENT__RETURN, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Event_class_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Event_class_feature", "_UI_Event_type"),
						EfsmPackage.Literals.EVENT__CLASS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EfsmPackage.Literals.EVENT__ARGS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(EfsmPackage.Literals.EVENT__ARGS, EfsmFactory.eINSTANCE.createParam()));
	}
