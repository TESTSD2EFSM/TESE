 ...
 * </p>
 * <ul>
 *   <li>{@link Efsm.efsm.impl.ParamImpl#getArgName <em>Arg Name</em>}</li>
 *   <li>{@link Efsm.efsm.impl.ParamImpl#getArgType <em>Arg Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParamImpl extends MinimalEObjectImpl.Container implements Param {
	...
	protected EClass eStaticClass() {
		return EfsmPackage.Literals.PARAM;
	}
	...
	public void setArgName(String newArgName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EfsmPackage.PARAM__ARG_NAME, oldArgName, argName));
	}
	...
	public void setArgType(String newArgType) {
		...
		argType = newArgType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EfsmPackage.PARAM__ARG_TYPE, oldArgType, argType));
	}
