 ...
 * </p>
 * <ul>
 *   <li>{@link Efsm.efsm.impl.AbstractStateImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractStateImpl extends MinimalEObjectImpl.Container implements AbstractState {
	...
	protected EClass eStaticClass() {
		return EfsmPackage.Literals.ABSTRACT_STATE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EfsmPackage.ABSTRACT_STATE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case EfsmPackage.ABSTRACT_STATE__NAME:
			return getName();
		}
