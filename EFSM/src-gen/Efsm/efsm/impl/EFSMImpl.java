 ...
 *   <li>{@link Efsm.efsm.impl.EFSMImpl#getContextVariables <em>Context Variables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EFSMImpl extends MinimalEObjectImpl.Container implements EFSM {
	...
	public EList<ContextVariable> getContextVariables() {
		if (contextVariables == null) {
			contextVariables = new EObjectContainmentEList<ContextVariable>(ContextVariable.class, this,
					EfsmPackage.EFSM__CONTEXT_VARIABLES);
		}
