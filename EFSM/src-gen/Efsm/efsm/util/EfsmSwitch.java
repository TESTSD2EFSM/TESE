 ...
 * @generated
 */
public class EfsmSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case EfsmPackage.EFSM: {
			EFSM efsm = (EFSM) theEObject;
			T result = caseEFSM(efsm);
			if (result == null)
		...
		case EfsmPackage.ABSTRACT_STATE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EFSM</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EFSM</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEFSM(EFSM object) {
		return null;
	}
