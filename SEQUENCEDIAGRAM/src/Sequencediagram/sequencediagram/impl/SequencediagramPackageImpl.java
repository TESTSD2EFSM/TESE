...
public class SequencediagramPackageImpl extends EPackageImpl implements SequencediagramPackage {
	 ...
	 */
	@Override
	public EAttribute getOperation_Guard() {
	 ...
	 */
	@Override
	public EReference getParam_Lifeline() {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getOperation_Guard(), ecorePackage.getEString(), "guard", null, 0, 1, Operation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getParam_Lifeline(), this.getLifeLine(), null, "lifeline", null, 0, 1, Param.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
