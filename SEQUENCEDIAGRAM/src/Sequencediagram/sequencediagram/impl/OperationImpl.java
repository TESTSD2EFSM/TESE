 ...
 *   <li>{@link Sequencediagram.sequencediagram.impl.OperationImpl#getGuard <em>Guard</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationImpl extends MinimalEObjectImpl.Container implements Operation {
	...
	public void setGuard(String newGuard) {
		...
		guard = newGuard;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SequencediagramPackage.OPERATION__GUARD, oldGuard, guard));
	}
