...
public interface SequencediagramPackage extends EPackage {
	...
	/**
	 * Returns the meta object for the attribute '{@link Sequencediagram.sequencediagram.Operation#getGuard <em>Guard</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Guard</em>'.
	 * @see Sequencediagram.sequencediagram.Operation#getGuard()
	 * @see #getOperation()
	 * @generated
	 */
	EAttribute getOperation_Guard();
	...
	/**
	 * Returns the meta object for the reference '{@link Sequencediagram.sequencediagram.Param#getLifeline <em>Lifeline</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Lifeline</em>'.
	 * @see Sequencediagram.sequencediagram.Param#getLifeline()
	 * @see #getParam()
	 * @generated
	 */
	EReference getParam_Lifeline();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute OPERATION__GUARD = eINSTANCE.getOperation_Guard();
		 ...
		 * @generated
		 */
		EReference PARAM__LIFELINE = eINSTANCE.getParam_Lifeline();
